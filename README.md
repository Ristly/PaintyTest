...
- После авторизации пользователю выдаётся JWT, который указывается в заголовке запроса для аутентификации. В swagger есть специальный пункт где можно указать данный токен (Рисунок ниже).

  
![image](https://github.com/Ristly/PaintyTest/assets/60257018/5b05244f-be34-4e84-a139-0f704dcd51bd)
